...
object TrinoConfiguration {
  ...
  val ENTRANCE_MAX_JOB_INSTANCE = CommonVars[Int]("linkis.entrance.max.job.instance", 100)
  val ENTRANCE_PROTECTED_JOB_INSTANCE = CommonVars[Int]("linkis.entrance.protected.job.instance", 0)
  val ENTRANCE_RESULTS_MAX_CACHE = CommonVars("linkis.trino.resultSet.cache.max", new ByteType("512k"))

  val DEFAULT_LIMIT = CommonVars[Int]("linkis.trino.default.limit", 5000)

  val TRINO_HTTP_CONNECT_TIME_OUT = CommonVars[java.lang.Long]("linkis.trino.http.connectTimeout", new lang.Long(60)) //seconds
  val TRINO_HTTP_READ_TIME_OUT = CommonVars[java.lang.Long]("linkis.trino.http.readTimeout", new lang.Long(60))

  val TRINO_URL = CommonVars[String]("linkis.trino.url", "http://127.0.0.1:8080")
  val TRINO_USER = CommonVars[String]("linkis.trino.user", null)
  val TRINO_PASSWORD = CommonVars[String]("linkis.trino.password", null)
  val TRINO_PASSWORD_CMD = CommonVars[String]("linkis.trino.passwordCmd", null)
  ...
  val TRINO_SSL_INSECURED = CommonVars[Boolean]("linkis.trino.ssl.insecured", false)
  ...
  val TRINO_SSL_KEYSTORE_PASSWORD = CommonVars[String]("linkis.trino.ssl.keystore.password", null)
  ...
  val TRINO_SSL_TRUSTSTORE_PASSWORD = CommonVars[String]("linkis.trino.ssl.truststore.password", null)

  val TRINO_FORBID_GRANT = CommonVars[Boolean]("linkis.trino.forbid.grant", true)
  val TRINO_FORBID_MODIFY_SCHEMA = CommonVars[Boolean]("linkis.trino.forbid.modifySchema", true)
}
